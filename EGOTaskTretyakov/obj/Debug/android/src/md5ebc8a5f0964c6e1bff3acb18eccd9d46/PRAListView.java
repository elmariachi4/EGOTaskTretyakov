...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PRAPinnedListView.PRAListView, PRAPinnedListView, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", PRAListView.class, __md_methods);
	}


	public PRAListView (android.content.Context p0) throws java.lang.Throwable
	{
		super (p0);
		if (getClass () == PRAListView.class)
			mono.android.TypeManager.Activate ("PRAPinnedListView.PRAListView, PRAPinnedListView, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}


	public PRAListView (android.content.Context p0, android.util.AttributeSet p1) throws java.lang.Throwable
	{
		super (p0, p1);
		if (getClass () == PRAListView.class)
			mono.android.TypeManager.Activate ("PRAPinnedListView.PRAListView, PRAPinnedListView, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:Android.Util.IAttributeSet, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0, p1 });
	}


	public PRAListView (android.content.Context p0, android.util.AttributeSet p1, int p2) throws java.lang.Throwable
	{
		super (p0, p1, p2);
		if (getClass () == PRAListView.class)
	...
	public PRAListView (android.content.Context p0, android.util.AttributeSet p1, int p2, int p3) throws java.lang.Throwable
	{
		super (p0, p1, p2, p3);
		if (getClass () == PRAListView.class)
	...
	{
		n_setOnScrollListener (p0);
	}

	private native void n_setOnScrollListener (android.widget.AbsListView.OnScrollListener p0);
